...
def download_torrent(torrent_file, proxies=None, total_data_transferred=0, retries=3):
    ...
    try:
        ...
        # Torrent finished, delete the downloaded file
        ...
        for file in os.listdir('./'):
            if file.endswith(".part"):  # Delete incomplete parts (if any)
...
def main():
    ...
    # Prompt for URL or file path if not provided
    ...
    if args.torrent:
        ...
        total_data_transferred = 0
        while True:
            download_file(args.file, proxies, total_data_transferred)
    else:
